...
class PostActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.postButton.setOnClickListener {
            ...
            val post:Post=Post(caption = binding.caption.editText?.text.toString(), postUrl = imageUrl!!, uid = Firebase.auth.currentUser!!.uid,time=System.currentTimeMillis().toString())
